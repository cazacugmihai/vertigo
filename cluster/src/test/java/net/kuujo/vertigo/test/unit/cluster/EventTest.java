...
public class EventTest {
  private final Serializer serializer = SerializerFactory.getSerializer(Event.class);
  ...
  public void testSerializeEvent() throws Exception {
    JsonObject serialized = new JsonObject()
      ...
      .putString("key", "foo")
      .putString("value", "bar");
    Event event = serializer.deserializeFromObject(serialized, Event.class);
    JsonObject json = serializer.serializeToObject(event);
