...
public final class StateClient {
  ...
  private final Handler<Message<JsonObject>> messageHandler = new Handler<Message<JsonObject>>() {
    ...
    public void handle(Message<JsonObject> message) {
      ...
      String request = message.body().getString("request");
      if (action == null) {
  ...
  public StateClient ping(String address, PingRequest request, long timeout, Handler<AsyncResult<PingResponse>> resultHandler) {
    ...
    vertx.eventBus().sendWithTimeout(address,
        new JsonObject().putString("action", "ping").putString("request", PingRequest.toJson(request)), timeout,
        new Handler<AsyncResult<Message<JsonObject>>>() {
          ...
          public void handle(AsyncResult<Message<JsonObject>> result) {
            if (result.failed()) {
              ...
              if (status.equals("ok")) {
                future.setResult(PingResponse.fromJson(result.result().body().getString("result")));
              }
              else {
  ...
  public StateClient sync(String address, SyncRequest request, long timeout, Handler<AsyncResult<SyncResponse>> resultHandler) {
    ...
    vertx.eventBus().sendWithTimeout(address,
        new JsonObject().putString("action", "sync").putString("request", SyncRequest.toJson(request)), timeout,
        new Handler<AsyncResult<Message<JsonObject>>>() {
          @Override
          public void handle(AsyncResult<Message<JsonObject>> result) {
            if (result.failed()) {
              ...
              String status = result.result().body().getString("status");
              if (status.equals("ok")) {
                future.setResult(SyncResponse.fromJson(result.result().body().getString("result")));
              }
              else {
                future.setFailure(new VertxException(result.result().body().getString("message", "")));
              }
  ...
  public StateClient poll(String address, PollRequest request, long timeout, Handler<AsyncResult<PollResponse>> resultHandler) {
    ...
    vertx.eventBus().sendWithTimeout(address,
        new JsonObject().putString("action", "poll").putString("request", PollRequest.toJson(request)), timeout,
        new Handler<AsyncResult<Message<JsonObject>>>() {
          @Override
          public void handle(AsyncResult<Message<JsonObject>> result) {
            if (result.failed()) {
              ...
              String status = result.result().body().getString("status");
              if (status.equals("ok")) {
                future.setResult(PollResponse.fromJson(result.result().body().getString("result")));
              }
              else {
                future.setFailure(new VertxException(result.result().body().getString("message", "")));
              }
  ...
  public StateClient submit(String address, SubmitRequest request, long timeout,
    ...
    vertx.eventBus().sendWithTimeout(address,
        new JsonObject().putString("action", "submit").putString("request", SubmitRequest.toJson(request)), timeout,
        new Handler<AsyncResult<Message<JsonObject>>>() {
          @Override
          public void handle(AsyncResult<Message<JsonObject>> result) {
            if (result.failed()) {
              ...
              String status = result.result().body().getString("status");
              if (status.equals("ok")) {
                future.setResult(SubmitResponse.fromJson(result.result().body().getString("result")));
              }
              else {
                future.setFailure(new VertxException(result.result().body().getString("message", "")));
              }
