...
public interface Component<T extends Component<T>> {
  ...
  /**
   * Returns the component's {@link InputCollector}. This is the element of the component
   * which subscribes to and receives input from other components.
   * 
  ...
  /**
   * Returns the component's {@link OutputCollector}. This is the element of the component
   * which receives subscriptions and emits messages to other components.
   * 
   ...
   * 
   * The instance context can be used to retrieve useful information about an entire
   * network.
   * 
   ...
   * Starts the component.
   * 
   * @param doneHandler An asynchronous handler to be invoked once the component is
   *          started.
   * @return The called component instance.
   */
