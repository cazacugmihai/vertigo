...
public interface ClusterManager {
   ...
   *   The value to set.
   * @param expire
   *   A key expiration in milliseconds.
   * @return
   *   The cluster manager.
   */
   ...
   *   The key to get.
   * @param resultHandler
   *   An asynchronous handler to be called with the result.
   * @return
   *   The cluster manager.
   */
   ...
   *
   * @param resultHandler
   *   An asynchronous handler to be called with a collection of available keys
   *   in the cluster.
   * @return
   *   The cluster manager.
   */
   ...
   *   The timeout in milliseconds.
   * @param doneHandler
   *   An asycnhronous handler to be called once the timeout is set.
   * @return
   *   The cluster manager.
   */
   ...
   *   The key to reset.
   * @param doneHandler
   *   An asynchronous handler to be called once the timeout has been reset.
   * @return
   *   The cluster manager.
   */
   ...
   *   The key to watch.
   * @param handler
   *   A handler to be called when an event occurs.
   * @return
   *   The cluster manager.
   */
   ...
   *   The event to watch.
   * @param handler
   *   A handler to be called when the event occurs.
   * @return
   *   The cluster manager.
   */
   ...
   *   A handler to be called when an event occurs.
   * @param doneHandler
   *   An asynchronous handler to be called once the key is being watched.
   * @return
   *   The cluster manager.
   */
   ...
   *   The handler to unwatch.
   * @param doneHandler
   *   An asynchronous handler to be called once the key has been unwatched.
   * @return
   *   The cluster manager.
   */
   ...
   *
   * @param resultHandler
   *   An asynchronous handler to be called once the reply is received.
   * @return
   *   The cluster manager.
   */
   ...
   *
   * @param address
   *   The address of the node for which to get info.
   * @param resultHandler
   *   An asynchronous handler to be called once the reply is received.
   * @return
   *   The cluster manager.
   ...
   *   The module name.
   * @param doneHandler
   *   An asynchronous handler to be called once the deployment is complete or fails.
   * @return
   *   The cluster manager.
   */
   ...
   *   The cluster manager.
   */
  ClusterManager deployModule(String deploymentID, String moduleName, JsonObject config, int instances, Handler<AsyncResult<String>> doneHandler);

  /**
   * Deploys a module to a specific node in the cluster.
   *
   * @param address
   *   The address of the node to which to deploy the module.
   * @param deploymentID
   *   The deployment ID.
   * @param moduleName
   *   The module name.
   ...
   *   The cluster manager.
   */
  ClusterManager deployModuleTo(String address, String deploymentID, String moduleName, JsonObject config, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployModuleTo(String address, String deploymentID, String moduleName, int instances, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployModuleTo(String address, String deploymentID, String moduleName, JsonObject config, int instances, Handler<AsyncResult<String>> doneHandler);

  /**
   * Deploys a module to a a group of nodes in the cluster.
   *
   * @param nodes
   *   A set of address of nodes in the group.
   * @param deploymentID
   *   The deployment ID.
   * @param moduleName
   *   The module name.
   ...
   *   The cluster manager.
   */
  ClusterManager deployModuleTo(Set<String> nodes, String deploymentID, String moduleName, JsonObject config, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployModuleTo(Set<String> nodes, String deploymentID, String moduleName, int instances, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployModuleTo(Set<String> nodes, String deploymentID, String moduleName, JsonObject config, int instances, Handler<AsyncResult<String>> doneHandler);
   ...
   *
   * @param address
   *   The address of the node to which to deploy the verticle.
   * @param deploymentID
   *   The deployment ID.
   * @param main
   *   The verticle main.
   ...
   *   The cluster manager.
   */
  ClusterManager deployVerticleTo(String address, String deploymentID, String main, JsonObject config, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployVerticleTo(String address, String deploymentID, String main, JsonObject config, int instances, Handler<AsyncResult<String>> doneHandler);

  /**
   * Deploys a verticle to a group of nodes in the cluster.
   *
   * @param nodes
   *   The addresses of the nodes to which to deploy the verticle.
   * @param deploymentID
   *   The deployment ID.
   * @param main
   *   The verticle main.
   ...
   *   The cluster manager.
   */
  ClusterManager deployVerticleTo(Set<String> nodes, String deploymentID, String main, JsonObject config, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployVerticleTo(Set<String> nodes, String deploymentID, String main, int instances, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployVerticleTo(Set<String> nodes, String deploymentID, String main, JsonObject config, int instances, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The verticle main.
   * @param multiThreaded
   *   Whether the worker is multi-threaded.
   * @param doneHandler
   *   An asynchronous handler to be called once the deployment is complete or fails.
   * @return
   *   The cluster manager.
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticle(String deploymentID, String main, JsonObject config, int instances, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticle(String deploymentID, String main, JsonObject config, boolean multiThreaded, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticle(String deploymentID, String main, int instances, boolean multiThreaded, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticle(String deploymentID, String main, JsonObject config, int instances, boolean multiThreaded, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(String address, String deploymentID, String main, JsonObject config, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(String address, String deploymentID, String main, int instances, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(String address, String deploymentID, String main, boolean multiThreaded, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(String address, String deploymentID, String main, JsonObject config, int instances, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(String address, String deploymentID, String main, JsonObject config, boolean multiThreaded, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(String address, String deploymentID, String main, int instances, boolean multiThreaded, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(String address, String deploymentID, String main, JsonObject config, int instances, boolean multiThreaded, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(Set<String> nodes, String deploymentID, String main, JsonObject config, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(Set<String> nodes, String deploymentID, String main, int instances, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(Set<String> nodes, String deploymentID, String main, boolean multiThreaded, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(Set<String> nodes, String deploymentID, String main, JsonObject config, int instances, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(Set<String> nodes, String deploymentID, String main, JsonObject config, boolean multiThreaded, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(Set<String> nodes, String deploymentID, String main, int instances, boolean multiThreaded, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The cluster manager.
   */
  ClusterManager deployWorkerVerticleTo(Set<String> nodes, String deploymentID, String main, JsonObject config, int instances, boolean multiThreaded, Handler<AsyncResult<String>> doneHandler);
   ...
   *   The deployment ID.
   * @param doneHandler
   *   An asynchronous handler to be called once the undeployment is complete or fails.
   * @return
   *   The cluster manager.
   */
   ...
   *
   * @param address
   *   The address of the node from which to undeploy the module.
   * @param deploymentID
   *   The deployment ID.
   * @param doneHandler
   *   An asynchronous handler to be called once the undeployment is complete or fails.
   ...
   *
   * @param nodes
   *   The addresses of the nodes from which to undeploy the module.
   * @param deploymentID
   *   The deployment ID.
   * @param doneHandler
   *   An asynchronous handler to be called once the undeployment is complete or fails.
   ...
   *
   * @param address
   *   The address of the node from which to undeploy the verticle.
   * @param deploymentID
   *   The deployment ID.
   * @param doneHandler
   *   An asynchronous handler to be called once the undeployment is complete or fails.
   ...
   *
   * @param nodes
   *   The addresses of the nodes from which to undeploy the verticle.
   * @param deploymentID
   *   The deployment ID.
   * @param doneHandler
   *   An asynchronous handler to be called once the undeployment is complete or fails.
